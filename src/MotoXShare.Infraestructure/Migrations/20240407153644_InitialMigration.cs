...
namespace MotoXShare.Infraestructure.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DeliveryRiderNotification",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryRiderNotification", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeliveryRiderNotification_Order_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryRiderNotification_OrderId",
                table: "DeliveryRiderNotification",
                column: "OrderId");
